...
export const AlbumCard = ({ albumName, albumNumber, albumPhoto, onPressHandler, setSelectedPhoto }) => {
  return (
    <View style={styles.cardStyle}>
      <View style={styles.imgContainer}>
        <TouchableOpacity onPress={() => {
          onPressHandler();
          setSelectedPhoto(albumPhoto);
        }}>
          <Image style={styles.imgStyle} source={albumPhoto} />
        </TouchableOpacity>
